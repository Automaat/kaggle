...
CANDIDATE = ROOT / "agents_2.0.x/round37_2b1_local_fallback"
...
def _ready_scheduler():
    ...
    scheduler = scheduler_module.LocalFallbackQueueScheduler()
...
def test_live_episode_uses_persistent_routes_across_walking_turns():
    ...
    assert scheduler.diagnostics.persisted_selections >= 50
    assert scheduler.rebuild_count < 100
